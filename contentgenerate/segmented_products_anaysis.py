...
def get_segmentation_prodcut_anaysis(enterprise_name,enterprise_industry_introduction,segmentation_description):
    template='''
        ...
        ###目标：
        请根据企业简介及其当前的产品形势，为该企业提供一份详细的产品推荐报告。报告应包含对企业现有产品的评估、潜在新产品方向的识别以及进入新产品的战略建议。
        ...
        评估现有产品的表现，包括市场份额、客户反馈、盈利能力和生命周期阶段等方面。
        当前市场形势分析
        研究[具体行业名称]内的主要趋势，了解消费者需求变化、技术进步以及竞争对手的新动向。
        识别出那些正在快速成长或者具有长期发展潜力的细分市场。
        潜在新产品方向识别
        根据企业的优势和市场需求，挑选出几个适合[具体企业名称]开发的新产品方向。
